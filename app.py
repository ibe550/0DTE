...
st.caption("● Market Closed | Data as of 08/25 15:30:00 ET")

# Ticker Metrics Grid (Mobile 2x2 Layout)
m1, m2 = st.columns(2)
with m1:
...
# Timeframe Selector & Pandas Frequency Mapping (Fixes Error)
...
np.random.seed(42)
dates = pd.date_range(end=datetime.now(), periods=n_bars, freq=pd_freq)
